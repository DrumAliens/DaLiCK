...
#     notes = [[54, 54, 54, 54], [51, 51, 51, 51, 51], [56, 56, 56, 56], [58, 58, 58, 58, 58]]
...
#  Build the OSC Message
oscMessage = [0.03*playVolume, numPhrase, delayPhrase, probVal, shufflePercent, phraseNumDivs]
oscMessage.append(count)
...
if stopNum == 0:
    client.send_message("/song/guitar/guitar1", oscMessage)
    # client.send_message("/song/guitar/guitar", [0.05*playVolume, 41, maskArray[3]*posVal1, 48, maskArray[2]*posVal2, 50, maskArray[1]*posVal3, 51, maskArray[0]*posVal4, numPhrase, delayPhrase])
else:
    client.send_message("/song/guitar/guitar1", [stopNum])
