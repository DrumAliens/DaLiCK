...
dur = [[2], [2, 2], [2], [2]]
slice = [[0], [0, 0], [0], [0]]
notes = [[Library.MIDIROOTNOTE], [Library.MIDIROOTNOTE, Library.MIDIROOTNOTE], [Library.MIDIROOTNOTE], [Library.MIDIROOTNOTE]]
...
if stopNum == 0 :
    client.send_message("/song/vocals/chop6", oscMessage)
else:
    client.send_message("/song/vocals/chop6", [stopNum])
