CHmUsiCK Library => SndBuf buffer => Envelope envelope => Envelope fader => Pan2 pan => dac;

"/song/sounds/frogs_left" => string oscInstrMsgName;

me.dir() + "Samples/frogsAnd/Drum_Frogs_32511__daveincamas_Left_Processed.wav" => buffer.read;
